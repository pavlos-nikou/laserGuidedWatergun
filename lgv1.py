...
def initiate():
    ...
    while True:
        ...
        if len(target) == 0:
            ...
            cv2.putText(frame, str(targer[1] - 320 + shiftx), (targer[1] + 30, targer[0]), cv2.FONT_ITALIC, 0.5,(0, 255, 0), 1)
            cv2.putText(frame, str(240 - targer[0] + shifty), (targer[1], targer[0] - 15), cv2.FONT_ITALIC, 0.5,(0, 255, 0), 1)
        ...
        fps=int(1/frametime)
        cv2.putText(frame, str(fps), (615, 15), cv2.FONT_ITALIC, 0.5, (0, 255, 0), 1)
